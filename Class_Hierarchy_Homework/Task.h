...
Write a C++ program that implements a simple class hierarchy to demonstrate
inheritance and polymorphism.
For example: You can create a base Shape class with a draw() method and
Circle and Rectangle classes that override the draw() method.
