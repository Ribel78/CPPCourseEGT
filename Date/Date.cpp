...
void Date::helpDecrement()
{
   ...
   if ( day != 1 )
      ...
      {
         year--; // decrement year
         month = 12; // last month of prev year
         day = 31; // last day of december
      } // end else
...
// overloaded output operator - outputs in format dd-mm-yyyy
ostream &operator<<( ostream &output, const Date &d )
{
...
//overloaded input operator - takes date input for date, month and year and assigns it to curent Date object
