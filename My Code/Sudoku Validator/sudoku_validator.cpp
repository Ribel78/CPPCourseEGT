...
int main()
{
  ...
  int array[] = {3,5,2,4,6,9,7,8,1,6,9,7,1,8,5,9,3,2,8,9,1,2,7,3,6,5,4,1,3,9,6,4,2,5,7,8,4,6,5,8,4,7,2,1,3,2,7,8,5,3,1,4,9,6,9,2,4,5,1,8,3,6,7,5,1,3,9,2,6,8,4,7,7,8,6,3,5,4,1,2,9};
    ...
    for (int i=0; i<3; i++){
        for (int j=0; j<3; j++){
            ...
            if (count_c > 1){ // използваме същия брояч count_c, който е ресетнат на 0 след последния цикъл по-горе
              cout << "The number "<< d << " appears " << count_c << " times in cell " << i+1 <<", " << j+1 << endl;
